...
<img src="cid:otp_header" width="100%">
	<div style="padding:15px; font-size:16px;">
		...
		<p>Your One Time Password (OTP) is <strong style="color:hsla(0, 100%, 40%, 0.774);">'.$otp.'</strong><br>
...
$mail->addEmbeddedImage('mail/img/otp_header.jpg', 'otp_header');
$mail->Body = $message;
